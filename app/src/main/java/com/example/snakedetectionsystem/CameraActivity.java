...
import com.example.snakedetectionsystem.ml.Model;
...
public class CameraActivity extends AppCompatActivity {
    ...
    public void classifyImage(Bitmap image){
        try {
            ...
            String[] classes = {"Cobra(නයා)", "NosedViper(පොලොන් තෙලිස්සා)", "Python(පිඹුරා)", "RatSnake(ගැරඬියා)", "Russell'sViper(තිත් පොලගා)" };
